...
Input:
  - profile: a string of the form 'Destination1,Percentage1,Destination2,Percentage2' etc. or the name of a pre-built profile
...
function getDestinationList(profile) {
  ...
  if (profile == "Custom") {
    ...
    return home.getRange(gc.incomeRow,6).getValue().split(',');
  } else {
...
function addIncome() {
  ...
  var profile = home.getRange(gc.incomeRow,5).getValue();
